...
The Anderson tight-binding model allows us to describe this phenomenon. We can say that the incoming wave is scattered by potentials arising from the disorder, and the scattered waves destructively interfere. This causes an exponential decay of the wavefunction $$\psi(x)$$ ~ $$e^{-x/\eta}$$. Thus, Anderson localization can be thought of as an interference phenomenon. 
