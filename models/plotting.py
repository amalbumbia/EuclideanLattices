...
class Plotting_Functions:
    ...
    def plot_pr(self, title = None, save = False):
        ...
        legend = f'L={self.L}, t={self.t}, W={self.disorder}, $\phi$={self.phi}'
        plt.scatter(self.evals, self.PR, c = "orange")
        plt.xlabel('Energy $E$')
    ...
    def plot_density_of_states(self, sigma=0.1, num_points=1000, title = None, save = False):
        ...
        plt.plot(E_vals, dos, color = "purple")
        plt.xlabel('Energy $E$')
    ...
    def plot_hall_conductance(self, num_points=100, title = None, save = False):
        """
        Compute and plot the Hall conductance. This is a toy simulation that does not really have anything to do with the rest of the models in this repository. 
        The point of this is to visualise the QHE. For this to be accurate in any meaningful way, I'm not convinced that the systems in this repository are the right platform. 
